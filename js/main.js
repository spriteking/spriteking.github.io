var e = "[[b;#44D544;]root]&#64;spriteking&#46;com";
var App = {
    echo: function(text) {
        this.echo(text);
    ...
    help: function() {
      showHelp(this);
        ...
        ls: function() {
            ...
            this.echo('0xroot.pgp');
            this.echo('cn0xroot.pem');
            this.echo('Radio_Hack.pdf');
            this.echo('cn0xroot.pdf');
            this.echo('passwords.txt');
            this.echo('Radio_Hub.py');
            this.echo('sdr-dev.txt');
    ...
    whoami: function() {
       ...
       blog: function() {
        ...
        setTimeout(function(){ document.location.href = 'http://cn0xroot.com'; }, 1000);
    },
    ...
    shutdown: function() {
        ...
        setTimeout(function(){ document.location.href = 'http://cn0xroot.com'; }, 2500);
        if(ga != undefined) ga('send', 'event', 'shutdown');
    },
    env: function() {
        this.echo("[[b;#44D544;]NAME=cn0xroot\nTITLE=SecurityResearcher;Student\nBLOG=http://www.cn0xroot.com\nGITHUB=https://github.com/cn0xroot\nTWITTER=@cn0xroot\n_=/usr/bin/env]");
        if(ga != undefined) ga('send', 'event', 'env');
    },
    cv: function() {
        this.echo("Loading my resume");
        setTimeout(function(){ document.location.href = 'http://cn0xroot.com/cn0xroot.pdf'; }, 1000);
        if(ga != undefined) ga('send', 'event', 'env');
    },
    oldsite: function() {
        this.echo("Loading my old site...");
        setTimeout(function(){ document.location.href = 'http://www.0xroot.cn'; }, 1000);
        if(ga != undefined) ga('send', 'event', 'env');
    },
    github: function() {
        this.echo("Loading my github...");
        setTimeout(function(){ document.location.href = 'https://github.com/cn0xroot'; }, 1000);
        if(ga != undefined) ga('send', 'event', 'env');
    },
    publicPGPkey: function() {
        this.echo("Loading PGP key...");
        setTimeout(function(){ document.location.href = 'http://cn0xroot.com/about-me'; }, 1000);
        if(ga != undefined) ga('send', 'event', 'env');
    }
}
...
jQuery(document).ready(function($) {
		...
		"Welcome to 雪碧 0xroot's personal website!\n\n"+
		"Quick Commands\n"+
		"\techo          env          help\n"+
		"\tid           ls           whoami]\n\n"+
		"[[b;#44D544;]root]&#64;cn0xroot&#46;com:~# env\n[[b;#44D544;]NAME=cn0xroot\n通信狗 硬件狗\nBLOG=http://cn0xroot.com\nGITHUB=https://github.com/cn0xroot\nTWITTER=@cn0xroot\n_=/usr/bin/env]",
                prompt: function(p){
            var path = '~'
            p(e + ":" + path + "# ");
        },
